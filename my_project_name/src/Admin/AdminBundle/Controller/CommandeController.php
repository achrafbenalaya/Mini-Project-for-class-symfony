...
use Admin\AdminBundle\Entity\Commande;
...
class CommandeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $commandes = $em->getRepository('AdminAdminBundle:Commande')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Admin\AdminBundle\Form\CommandeType', $commande);
    ...
    {
        $deleteForm = $this->createDeleteForm($commande);
        $editForm = $this->createForm('Admin\AdminBundle\Form\CommandeType', $commande);
